...
static void rna_def_tool_settings(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(
      ...
      "remapped inside the cycle time range, and keeps ends in sync. Curves newly added "
      "to actions with a cyclic custom frame range are automatically made cyclic");
